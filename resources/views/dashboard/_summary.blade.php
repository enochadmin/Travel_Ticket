<div class="mx-auto max-w-4xl space-y-6">
    ...
    <div class="overflow-hidden rounded-2xl border border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-sm">
        <div class="px-6 py-6 sm:px-8" style="background:linear-gradient(135deg,#0c4a6e 0%,#0ea5e9 55%,#38bdf8 100%);">
            <p class="text-xs font-semibold uppercase tracking-[0.2em] text-sky-200">Dashboard</p>
            <h2 class="mt-2 text-2xl font-bold text-white sm:text-3xl">{{ $dashboardTitle }}</h2>
            <p class="mt-2 text-sm text-sky-100 max-w-2xl">{{ $dashboardSubtitle }}</p>
