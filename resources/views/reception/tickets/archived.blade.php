<x-app-layout>
    <x-slot name="pageTitle">Archived (Processed) Tickets</x-slot>

    <div class="space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <form method="GET" action="{{ route('reception.tickets.archived') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                    <label class="text-xs text-gray-500 font-semibold">Archived From</label>
                    <input type="date" name="date_from" value="{{ request('date_from') }}"
                        class="mt-1 w-full rounded-lg border-gray-200 focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                    <label class="text-xs text-gray-500 font-semibold">Archived To</label>
                ...
                <div class="md:col-span-5 flex items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('reception.tickets.archived') }}" class="text-sm text-gray-500 hover:text-gray-700">
                        Clear
                    </a>
                </div>
            </form>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                <h2 class="text-base font-semibold text-gray-700">Archived (Processed) Tickets</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-gray-700">
                                    ...
                                    <div class="mt-2 text-xs text-gray-500">
                                        ...
                                        {{ optional($ticket->archived_at)->format('M d, Y') ?? '—' }}
                                        <span class="text-gray-400">by</span> {{ $ticket->archivedBy?->name ?? '—' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-10 text-center text-gray-400">No archived tickets found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
